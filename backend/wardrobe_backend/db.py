...
class Database:
    ...
    def init(self):
        with self.conn() as c:
            ...
            models=[("qwen3-vl-2b","Qwen3-VL 2B","not_installed","2B BF16","Denali-AI/qwen3-vl-2b-sft-grpo-v9","https://huggingface.co/Denali-AI/qwen3-vl-2b-sft-grpo-v9","Apache-2.0"),("stylewell-4b","StyleWell 4B","not_installed","4B","future","https://huggingface.co/HelloWorld0204/Classification-StyleWell-model","unknown"),("qwen3-vl-8b","Qwen3-VL 8B","not_installed","8B","future","https://huggingface.co/Denali-AI/qwen3-vl-8b-garment-classifier","Apache-2.0")]
