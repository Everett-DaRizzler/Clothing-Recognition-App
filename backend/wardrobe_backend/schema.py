...
class ClothingAnalysis(BaseModel):
    imageId: str; modelId: str = "stylewell-4b"; modelVersion: str = "HelloWorld0204/Classification-StyleWell-model"; category: str | None = None; type: str | None = None; color: str | None = None; secondaryColors: list[str] = Field(default_factory=list); pattern: str | None = None; fabric: str | None = None; fit: str | None = None; style: list[str] = Field(default_factory=list); occasion: list[str] = Field(default_factory=list); season: list[str] = Field(default_factory=list); confidence: Confidence = Field(default_factory=Confidence); rawResponse: str = ""; inferenceTimeMs: int = 0; parseSuccess: bool = True
